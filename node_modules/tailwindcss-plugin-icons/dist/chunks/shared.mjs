...
class TailwindcssPluginIconsError extends Error {
  ...
  static rethrowIfInstanceof(error) {
...
export { TailwindcssPluginIconsError, encodeSvg, iconToDataUrl, iconUrl, isUri, loadIconFromIconifyJson, parseIconName, readJson, toKebabCase, uriToFilename };
